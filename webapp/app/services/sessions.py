...
def list_sessions(db: Session, player_ids: list[int] | None = None) -> list[SessionSummary]:
    ...
    without it, this groups every match in the whole DB into sessions,
    which is both wrong (pulls in players unrelated to the viewer) and,
    at a large match count, slow."""
